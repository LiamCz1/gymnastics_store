# AIO Content & Architecture Plan

## 1. Summary
The AIO plan is a strategic content and site architecture framework for a fitness-oriented e-commerce and class booking site. It focuses on making the business easier to discover for AI search, organic search, and qualified customers by clearly separating products, classes, goals, and guides while preserving a strong brand connection.
...
### Classes hub summary
**Browse beginner through advanced fitness classes led by qualified trainers. Compare class format, intensity, schedule, location, price, availability, and instructor experience before booking an in-person or online session.**
